...
# run global test
global.test.res <- global.test(final.results, n.top.scores = 10)
...
Users may also experience an error when executing `epistasis.test` specifying "cannot run test, all SNPs are in LD". The epistasis test can only be computed if at least two SNPs are located in different LD blocks, otherwise other methods, not provided in this package, are required. 
