...
By default, the thickness of the SNP-to-SNP line segments in these plots is proportional to the log of the graphical score for that pair, and the area of the node circle is proportional to the log of the sum of the graphical scores for all pairs that include that SNP.  
