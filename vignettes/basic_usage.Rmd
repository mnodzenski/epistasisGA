...
The `element.test.stats` object reports the fitness score sums for each chromosome size for the observed data. The `element.pvals` object reports the proportion of permutation based fitness score sum statistics, $T_d$ that exceed the observed statistic for each chromosome size. In this case, we see that none of the permutation based statistics exceeded the observed value for either chromosome size. 
