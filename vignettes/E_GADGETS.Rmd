...
The E-GADGETS fitness score involves a standardization step, where the standardization is based on 10,000 random sets initiated at algorithm outset. The relevant means and standard deviations are stored in the `results.dir` directory, in the `null.mean.sd.info.rds` file. That information will be required to carry out permutation-based inferential procedures later. 
