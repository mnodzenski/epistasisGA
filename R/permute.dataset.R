...
#'
#' This function creates permuted datasets for permutation based hypothesis testing of genetic algorithm fitness scores.
#'
#' @param case.genetic.data The genetic data of the disease affected children. Columns are SNPs, and rows are individuals.
...
#' @param father.genetic.data The genetic data for the fathers of the cases. Columns are SNPs, rows are individuals.
