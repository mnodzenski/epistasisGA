...
GxE_fitness_score_mvlm <- function(case_genetic_data_, mom_genetic_data_, dad_genetic_data_, exposure_mat_, target_snps, weight_lookup, null_means, null_se, continuous_exp, exposure_quantile_vec, n_different_snps_weight = 2L, n_both_one_weight = 1L, permute_exposure = FALSE) {
    .Call('_epistasisGA_GxE_fitness_score_mvlm', PACKAGE = 'epistasisGA', case_genetic_data_, mom_genetic_data_, dad_genetic_data_, exposure_mat_, target_snps, weight_lookup, null_means, null_se, continuous_exp, exposure_quantile_vec, n_different_snps_weight, n_both_one_weight, permute_exposure)
}
...
GxE_fitness_score_mvlm_list <- function(case_genetic_data_, mom_genetic_data_, dad_genetic_data_, exposure_mat_, chromosome_list, weight_lookup, null_means, null_se, continuous_exp, exposure_quantile_vec, n_different_snps_weight = 2L, n_both_one_weight = 1L) {
    .Call('_epistasisGA_GxE_fitness_score_mvlm_list', PACKAGE = 'epistasisGA', case_genetic_data_, mom_genetic_data_, dad_genetic_data_, exposure_mat_, chromosome_list, weight_lookup, null_means, null_se, continuous_exp, exposure_quantile_vec, n_different_snps_weight, n_both_one_weight)
}

GxE_mvlm_fitness_vec_mat <- function(case_genetic_data_, mom_genetic_data_, dad_genetic_data_, exposure_mat_, chromosome_list, weight_lookup, null_means, null_se, continuous_exp, exposure_quantile_vec, n_different_snps_weight = 2L, n_both_one_weight = 1L) {
    .Call('_epistasisGA_GxE_mvlm_fitness_vec_mat', PACKAGE = 'epistasisGA', case_genetic_data_, mom_genetic_data_, dad_genetic_data_, exposure_mat_, chromosome_list, weight_lookup, null_means, null_se, continuous_exp, exposure_quantile_vec, n_different_snps_weight, n_both_one_weight)
}

compute_population_fitness <- function(case_genetic_data, complement_genetic_data, ld_block_vec, chromosome_list, weight_lookup, case_genetic_data_n, mom_genetic_data, dad_genetic_data, exposure_mat_n, weight_lookup_n, null_mean_vec, null_se_vec, continuous_exp, exposure_quantile_vec, n_different_snps_weight = 2L, n_both_one_weight = 1L, recessive_ref_prop = 0.75, recode_test_stat = 1.64, E_GADGETS = FALSE) {
