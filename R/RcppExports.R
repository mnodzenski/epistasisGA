...
initiate_population <- function(case_genetic_data, n_chromosomes, chromosome_size, generation, snp_chisq, max_generations = 500L, initial_sample_duplicates = FALSE, chromosome_list = NULL, fitness_score_list = NULL, top_fitness = NULL, top_generation_chromosome = NULL, gen_chromosome_list = NULL, sum_dif_vec_list = NULL, risk_allele_vec_list = NULL) {
    .Call('_snpGADGET_initiate_population', PACKAGE = 'snpGADGET', case_genetic_data, n_chromosomes, chromosome_size, generation, snp_chisq, max_generations, initial_sample_duplicates, chromosome_list, fitness_score_list, top_fitness, top_generation_chromosome, gen_chromosome_list, sum_dif_vec_list, risk_allele_vec_list)
}
