...
#' from case-parent trios or affected/unaffected sibling pairs.
...
#' @param case2.mat A logical matrix indicating whether, for each SNP, the
#' case carries 2 copies of the minor allele.
#' @param case0.mat A logical matrix indicating whether, for each SNP, the
#' case carries 0 copies of the minor allele.
#' @param comp2.mat A logical matrix indicating whether, for each SNP, the
#' complement/unaffected sibling carries 2 copies of the minor allele.
#' @param comp0.mat A logical matrix indicating whether, for each SNP, the
#' complement/unaffected sibling carries 0 copies of the minor allele.
...
#'  to 1.64. See the GADGETS paper for specific details.
#' @param epi.test A logical indicating whether the function should return the
#' information required to run function \code{epistasis.test}.
#' for a given SNP. See the GADGETS paper for specific details on the
#' implementation of this argument.
...
chrom.fitness.score <- function(case.genetic.data, complement.genetic.data,
                                case.comp.differences, target.snps,
                                cases.minus.complements, both.one.mat,
                                block.ld.mat, weight.lookup, case2.mat,
                                case0.mat, comp2.mat, comp0.mat,
                                ...
                                dif.coding = FALSE) {
    chrom_fitness_score(
        case.genetic.data, complement.genetic.data, case.comp.differences,
        target.snps, cases.minus.complements, both.one.mat, block.ld.mat,
