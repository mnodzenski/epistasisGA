...
#' chrom.fitness.score.original(case, comp, case.comp.diff, c(1, 4, 7),
#'                     case.minus.comp, both.one.mat,
#'                     block.ld.mat, weight.lookup)
#'
#' @export

chrom.fitness.score.original <- function(case.genetic.data, complement.genetic.data, case.comp.differences,
